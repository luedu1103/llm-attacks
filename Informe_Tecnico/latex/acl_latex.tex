...
\textit{[Tabla agregada con métricas por ataque e intensidad sobre el dataset
completo.]}

\subsection{Experimentos por enunciado y resultados obtenidos}
\label{sec:results-per-task}

\textit{[Resultados desagregados para cada uno de los siete tipos de tarea
bajo cada ataque e intensidad.]}

\subsection{Análisis de resultados}
\label{sec:results-analysis}

\textit{[Análisis cualitativo y cuantitativo: en qué tareas falla el modelo
con mayor frecuencia, patrones de error, casos representativos de
\textit{flips}, interpretación de los resultados.]}
